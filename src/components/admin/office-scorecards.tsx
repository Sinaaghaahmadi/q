...
export function OfficeScorecards({ scores }: { scores: OfficeScore[] }) {
  ...
  return (
    <PanelSection
      title={t("scoreTitle")}
      hint={t("sectionHint.scores")}
      href="/admin/exchanges"
      linkLabel={t("openOffices")}
      bodyClassName="space-y-3"
      footer={scores.length > 0 ? t("scoreHint") : undefined}
    >
      {scores.length === 0 ? (
                  ...
                  >
                    ...
                    <td className="num px-3 py-3 text-end">
                      {score.orders === 0 ? (
                        ...
                        <Link
                          href={`/admin/orders?office=${score.officeId}`}
                    ...
                    <td className="num px-3 py-3 text-end text-ink-600">
                      {score.averageMinutes === null ? t("noData") : duration(score.averageMinutes)}
                    </td>
                    ...
                    <td className="py-3 ps-3 text-end">
                      {score.disputeRate === null ? (
                        ...
                        <Link
                          href={`/admin/orders?office=${score.officeId}&state=disputed`}
