...
export function P2pModeration({
  ...
  return (
    <div className="space-y-4">
      ...
      {disputed.length > 0 ? (
        <PanelSection title={t("disputesTitle")} hint={t("disputesHint")} bodyClassName="space-y-2">
          {disputed.map((order) => (
            <div
              key={order.id}
      ...
      <PanelSection title={t("listings")} hint={t("listingsHint")} bodyClassName="space-y-3">
        {offers.length === 0 ? (
